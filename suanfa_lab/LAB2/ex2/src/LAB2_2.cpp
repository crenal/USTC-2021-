...
int main()
{
    ofstream outf("suanfa_lab\\LAB2\\ex2\\output\\result.txt");
    ofstream outf2("suanfa_lab\\LAB2\\ex2\\output\\time.txt");
    auto data=fopen("suanfa_lab\\LAB2\\ex2\\input\\2_2_input.txt","r");    
