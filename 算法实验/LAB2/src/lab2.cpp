...
ofstream outFile2("LAB2\\output\\time.txt");
void LCS_LENGTH(vector<char> x,vector<char> y);
set<string> LCS;string path1="LAB2\\output\\result_";string path2=".txt";string path;
...
int main() 
{
    ...
    FILE *data; 
    int i;
    data=fopen("LAB2\\input\\1_2_input.txt","r"); 
    for(i=1;i<=5;i++)
    {
        int n;char s;
        fscanf (data,"%d",&n) ;
